...
mkdir -p "$LIBDIR/vscode-status"
install -m 0644 "$HERE/vscode-status/extension.js"    "$LIBDIR/vscode-status/extension.js"
install -m 0644 "$HERE/vscode-status/package.json.in" "$LIBDIR/vscode-status/package.json.in"
